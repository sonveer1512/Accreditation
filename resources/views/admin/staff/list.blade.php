                                ...
                                <div class="row">
                                    ...
                                    <div class="col text-end dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink2">
                                            ...
                                            <!-- @if($value->flag == 1)
                                                <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#deletepopup" data-bs-toggle="modal" onclick="deletepopup(<?= $value->id ?>,'vendor','activate')" aria-controls="editmodal"><i class="ri-checkbox-circle-line me-2"></i></i>Active</a></li>
                                            @else
                                                <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#deletepopup" data-bs-toggle="modal" onclick="deletepopup(<?= $value->id ?>,'vendor','deactivate')" aria-controls="editmodal"><i class="ri-alert-line me-2 align-middle"></i>Deactive</a></li>
                                            @endif -->
                            ...
                            <div class="col-lg-4 col">
                                <div class="team-profile-img">
                                    ...
                                    @if(empty($value->image) )
                                        ...
                                        @else   
                                        <img src="{{asset('uploads/staff/image/'.$value->image)}}" alt="" class="img-fluid d-block rounded-circle" />
                                    ...
                                    <div class="team-content">
                                        ...
                                        <p class="text-muted mb-0"><?php echo $value['role']; ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col">
                                <div class="row text-muted text-center">
                                    <div class="col-6 border-end border-end-dashed">
                                        <h6 class="mb-1"><?php echo $value->phone ?? ''; ?></h6>
                                        <p class="text-muted mb-0">Mobile</p>
                                    </div>
                                    <div class="col-6">
                                        <h6 class="mb-1"><?php echo $value->email ?? ''; ?></h6>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="">
                                        ...
                                        <input type="number" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="10" name="phone" id="phone" placeholder="Enter Mobile No">
                                    </div>
